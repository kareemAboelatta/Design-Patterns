package _patterns.behavioral.interpreter_pattern
...
/**
 *The Interpreter pattern is a _patterns.behavioral design pattern that provides a way to evaluate language grammar or expressions. It defines a representation for the grammar of a language and provides an interpreter that can parse the input and evaluate it.
